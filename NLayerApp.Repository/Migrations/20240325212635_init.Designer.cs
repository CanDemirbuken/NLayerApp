            ...
            modelBuilder.Entity("NLayerApp.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 3, 26, 0, 26, 35, 600, DateTimeKind.Local).AddTicks(6563),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 3, 26, 0, 26, 35, 600, DateTimeKind.Local).AddTicks(6571),
                            Name = "Kalem 2",
                            Price = 200m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2024, 3, 26, 0, 26, 35, 600, DateTimeKind.Local).AddTicks(6572),
                            Name = "Kalem 3",
                            Price = 600m,
                            Stock = 60
                        },
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2024, 3, 26, 0, 26, 35, 600, DateTimeKind.Local).AddTicks(6574),
                            Name = "Kitap 2",
                            Price = 6600m,
                            Stock = 70
                        });
